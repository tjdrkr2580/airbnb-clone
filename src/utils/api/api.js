...
export const getInfinityHouseFilterSearch = (page, data, id) => {
    let res;
    if (id) {
        res = axios.get(`api/houses?adminDistrict=${data.adminDistrict}&peopleCount=${data.peopleCount}&minPrice=${data.minPrice}&maxPrice=${data.maxPrice}&startDate=${data.startDate}&endDate=${data.endDate}&page=${page}&userId=${id}`);
    } else {
        res = axios.get(`api/houses?adminDistrict=${data.adminDistrict}&peopleCount=${data.peopleCount}&minPrice=${data.minPrice}&maxPrice=${data.maxPrice}&startDate=${data.startDate}&endDate=${data.endDate}&page=${page}`);
    }
    return res;
};
